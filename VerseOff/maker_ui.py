...
try:
    ...
    pass  # Allow UI to run/test standalone if needed
...
class ConnectionPage(QWizardPage):
    def __init__(self, parent=None):
        ...
        self.client_id_label = QLabel("Entra ID Client ID:")
...
class AppSelectionPage(QWizardPage):
    ...
    def fetch_apps(self):
        ...
        try:
            ...
            for app in apps:
                item = QListWidgetItem(f"{app.get('name')} ({app.get('uniquename')})")
                item.setData(Qt.ItemDataRole.UserRole, app.get('appmoduleid'))
...
class GenerationPage(QWizardPage):
    ...
    def initializePage(self):
        ...
        try:
            ...
            # Use current directory / out as default
