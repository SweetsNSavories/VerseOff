# VerseOff Sample Sales App - VerseOff source project

This project was generated by VerseOff Maker from the Dataverse model-driven
app `verseoff_sample_sales`. It contains the selected app navigation, table metadata,
...
The executable is written to `dist\VerseOffSampleSalesApp.exe`.
