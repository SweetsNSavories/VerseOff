...
(function (IoTConnector) {
    ...
    (function (IoTSettings) {
        var IoTSettingsRibbon = /** @class */ (function () {
            function IoTSettingsRibbon() {
            }
            IoTSettingsRibbon.configureIoTSuggestions = function (control) {
                var parameters = {};
                parameters["param_isProvisionCompleted"] = 1;
                var dialogHeight = 800;
                var dialogWidth = 1000;
                var dialogOptions = {
                    height: dialogHeight,
                    width: dialogWidth,
                    position: 2 // right pane
                };
                Xrm.Navigation.openDialog(IoTConnector.Common.Constants.IoTSuggestionsDialog.DialogName, dialogOptions, parameters).then(function (param) {
                    //TODO: task 1595464, after submit request, refresh current form and show the suggestions tab
                });
            };
            return IoTSettingsRibbon;
        }());
        IoTSettings.IoTSettingsRibbon = IoTSettingsRibbon;
    })(IoTSettings = IoTConnector.IoTSettings || (IoTConnector.IoTSettings = {}));
})(IoTConnector || (IoTConnector = {}));
