...
/// <reference path="../../../../../Plugins/IoT/CrmPackage/WebResources/msdyn_/IoT/Common/Constants.ts" />
/// <reference path="../../../../../Plugins/IoT/CrmPackage/WebResources/msdyn_/IoT/Utils/ApiUtils/Common.ts" />
/// <reference path="../../../../../Plugins/IoT/CrmPackage/WebResources/msdyn_/IoT/Utils/ApiUtils/Fields.ts" />
/// <reference path="../../../../../Plugins/IoT/CrmPackage/WebResources/msdyn_/IoT/Utils/ApiUtils/WebApiSDK.ts" />
/// <reference path="../../../../../Plugins/IoT/CrmPackage/WebResources/msdyn_/IoT/Utils/ODataUtils.ts" />
/// <reference path="../../../../../Plugins/IoT/CrmPackage/WebResources/msdyn_/IoT/Utils/ServiceEndpointUtils.ts" />
/// <reference path="../../../../../Plugins/IoT/CrmPackage/WebResources/msdyn_/IoT/Common/Constants.ts" />
/// <reference path="../Utils/IoTAssetCommonUtils.ts" />
...
var msdyn = msdyn || {};
msdyn.IotAssetCommon = msdyn.IotAssetCommon || {};
msdyn.IotAssetCommon.CustomerAssetForm = msdyn.IotAssetCommon.CustomerAssetForm || {};
msdyn.IotAssetCommon.CustomerAssetForm.isInitialFormLoad = true;
msdyn.IotAssetCommon.CustomerAssetForm.countConnectedDevices = 0;
msdyn.IotAssetCommon.CustomerAssetForm.connectedDeviceRole = "{9C86F660-5F5B-E611-810B-00155DBD6A1D}";
msdyn.IotAssetCommon.CustomerAssetForm.isIotDeviceInUse = null;
msdyn.IotAssetCommon.CustomerAssetForm.getIsIotDeviceInUse = function () {
    return __awaiter(this, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _a = msdyn.IotAssetCommon.CustomerAssetForm;
                    if (!(msdyn.IotAssetCommon.CustomerAssetForm.isIotDeviceInUse == null)) return [3 /*break*/, 2];
                    return [4 /*yield*/, msdyn.IotAssetCommon.RibbonUtils.displayIfIoTIsInUse()];
                case 1:
                    _b = _c.sent();
                    return [3 /*break*/, 3];
                case 2:
                    _b = msdyn.IotAssetCommon.CustomerAssetForm.isIotDeviceInUse;
                    _c.label = 3;
                case 3:
                    _a.isIotDeviceInUse = _b;
                    return [2 /*return*/, msdyn.IotAssetCommon.CustomerAssetForm.isIotDeviceInUse];
            }
        });
    });
};
msdyn.IotAssetCommon.CustomerAssetForm.onLoad = function (executionContext) {
    return __awaiter(this, void 0, void 0, function () {
        var generalTab, promises, assetId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    msdyn.IotAssetCommon.CustomerAssetForm.formContext = executionContext.getFormContext();
                    msdyn.IotAssetCommon.CustomerAssetForm.isInitialFormLoad = true;
                    generalTab = msdyn.IotAssetCommon.CustomerAssetForm.formContext.ui.tabs.get(IotAssetCommon.Common.Constants.TabNames.CustomerAssetFormGeneralTab)
                        || msdyn.IotAssetCommon.CustomerAssetForm.formContext.ui.tabs.get(IotAssetCommon.Common.Constants.TabNames.CustomerAssetFormMobileGeneralTab);
                    promises = [];
                    if (msdyn.IotAssetCommon.CustomerAssetForm.formContext.ui.getFormType() !== 1 /* Create */) {
                        assetId = msdyn.IotAssetCommon.CustomerAssetForm.formContext.data.entity.getId();
                        promises.push(msdyn.IotAssetCommon.CustomerAssetForm.getAssetConnectedDevicesIds(assetId).then(function (devicesIds) {
                            devicesIds = devicesIds || [];
                            var currentCountConnectedDevices = devicesIds.length;
                            msdyn.IotAssetCommon.CustomerAssetForm.ShoworHideDeviceInsightsTab(currentCountConnectedDevices);
                            msdyn.IotAssetCommon.CustomerAssetForm.displayHideSendCommandButton(currentCountConnectedDevices);
                            msdyn.IotAssetCommon.CustomerAssetForm.displayHideField(currentCountConnectedDevices, IotAssetCommon.Common.Constants.Msdyn_customerasset.AttributeRegistrationStatus);
                            msdyn.IotAssetCommon.CustomerAssetForm.setDeviceIdField(devicesIds).then(function () {
                                msdyn.IotAssetCommon.CustomerAssetForm.displayHideField(currentCountConnectedDevices, IotAssetCommon.Common.Constants.Msdyn_customerasset.AttributeDeviceId);
                            });
                            msdyn.IotAssetCommon.CustomerAssetForm.ShowOrHideIoTSections(generalTab, devicesIds);
                        }));
                    }
...
msdyn.IotAssetCommon.CustomerAssetForm.ShoworHideDeviceInsightsTab = function (currentCountConnectedDevices) {
    return __awaiter(this, void 0, void 0, function () {
        var deviceInsightsTab, shouldShow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    deviceInsightsTab = msdyn.IotAssetCommon.CustomerAssetForm.formContext.ui.tabs.get(IoTConnector.Common.Constants.TabNames.DeviceInsightsTab);
                    return [4 /*yield*/, msdyn.IotAssetCommon.CustomerAssetForm.getIsIotDeviceInUse()];
                case 1:
                    shouldShow = _a.sent();
                    if (deviceInsightsTab && shouldShow) {
                        // Check if there is a valid connection to a device and accordingly show the tab.
                        if (currentCountConnectedDevices > 0) {
                            //Determine showDeviceInsightsTab based on Device Insights Config
                            IoTAssetCommon.Utils.IoTAssetCommonUtils.shouldDeviceInsightsBeVisible().then(function (showDeviceInsights) {
                                deviceInsightsTab.setVisible(showDeviceInsights);
                            });
                        }
                    }
                    else if (deviceInsightsTab) {
                        deviceInsightsTab.setVisible(false);
                    }
                    return [2 /*return*/];
            }
        });
...
msdyn.IotAssetCommon.CustomerAssetForm.SetVisibility = function (elements, makeVisible) {
    for (var _i = 0, elements_1 = elements; _i < elements_1.length; _i++) {
        var element = elements_1[_i];
        if (element) {
            element.setVisible(makeVisible);
        }
    }
};
// Logic to show or hide IoT related sections
msdyn.IotAssetCommon.CustomerAssetForm.ShowOrHideIoTSections = function (generalTab, devicesIds) {
    return __awaiter(this, void 0, void 0, function () {
        var commandHistoryTab, alertsTab, deviceSummaryVisualizationSection, connectedDeviceReadingsSection, shouldShow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    msdyn.IotAssetCommon.CustomerAssetForm.showOrHideConnectedDeviceAttributesSection(generalTab);
                    commandHistoryTab = msdyn.IotAssetCommon.CustomerAssetForm.formContext.ui.tabs.get(IotAssetCommon.Common.Constants.TabNames.CommandHistoryTab);
                    alertsTab = msdyn.IotAssetCommon.CustomerAssetForm.formContext.ui.tabs.get(IotAssetCommon.Common.Constants.TabNames.AlertsTab);
                    if (generalTab && generalTab.sections) {
                        deviceSummaryVisualizationSection = generalTab.sections.get(IotAssetCommon.Common.Constants.SectionNames.DeviceSummaryVisualizationSection);
                        connectedDeviceReadingsSection = !IoTConnector.ApiUtils.IsMobile() && generalTab.sections.get(IotAssetCommon.Common.Constants.SectionNames.ConnectedDeviceReadingsSection);
                    }
                    if (!(commandHistoryTab || alertsTab || deviceSummaryVisualizationSection || connectedDeviceReadingsSection)) return [3 /*break*/, 2];
                    return [4 /*yield*/, msdyn.IotAssetCommon.CustomerAssetForm.getIsIotDeviceInUse()];
                case 1:
                    shouldShow = _a.sent();
                    if (shouldShow && devicesIds && devicesIds.length === 1) {
                        msdyn.IotAssetCommon.CustomerAssetForm.SetVisibility([commandHistoryTab, alertsTab], true);
                        msdyn.IotAssetCommon.CustomerAssetForm.doesConnectedDeviceHaveDeviceId(devicesIds[0]).then(function (hasDeviceId) {
                            msdyn.IotAssetCommon.CustomerAssetForm.SetVisibility([connectedDeviceReadingsSection], hasDeviceId);
                            msdyn.IotAssetCommon.CustomerAssetForm.SetVisibility([deviceSummaryVisualizationSection], hasDeviceId);
                        });
                    }
                    else {
                        msdyn.IotAssetCommon.CustomerAssetForm.SetVisibility([commandHistoryTab, alertsTab, deviceSummaryVisualizationSection, connectedDeviceReadingsSection], false);
                    }
                    _a.label = 2;
...
// Show or hide the fields depending on the number of connected devices.
msdyn.IotAssetCommon.CustomerAssetForm.displayHideField = function (currentCountConnectedDevices, fieldLogicalName) {
    return __awaiter(this, void 0, void 0, function () {
        var formContext, control, shouldShow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    formContext = msdyn.IotAssetCommon.CustomerAssetForm.formContext;
                    control = IoTConnector.ApiUtils.Fields.GetControl(formContext, fieldLogicalName);
                    return [4 /*yield*/, msdyn.IotAssetCommon.CustomerAssetForm.getIsIotDeviceInUse()];
                case 1:
                    shouldShow = _a.sent();
                    if (!control) {
                    ...
                    fieldLogicalName == IotAssetCommon.Common.Constants.Msdyn_customerasset.AttributeRegistrationStatus ?
                        control.setVisible(shouldShow && currentCountConnectedDevices > 0) : control.setVisible(shouldShow && currentCountConnectedDevices <= 1);
                    return [2 /*return*/];
            }
        });
    });
};
msdyn.IotAssetCommon.CustomerAssetForm.setDeviceIdField = function (devicesIds) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var formContext = msdyn.IotAssetCommon.CustomerAssetForm.formContext;
                    var deviceIdField = IoTConnector.ApiUtils.Fields.GetControl(formContext, IotAssetCommon.Common.Constants.Msdyn_customerasset.AttributeDeviceId);
                    var deviceIdFieldAttr = IoTConnector.ApiUtils.Fields.GetEntityAttribute(formContext, IotAssetCommon.Common.Constants.Msdyn_customerasset.AttributeDeviceId);
                    if (!deviceIdField || !deviceIdFieldAttr) {
                        resolve();
                        return;
                    }
                    // If there is one connected device, set the device id field.
                    if (devicesIds && devicesIds.length === 1) {
                        var deviceIdFieldName_1 = IotAssetCommon.Common.Constants.Msdyn_customerasset.AttributeDeviceId;
                        var deviceId = devicesIds[0];
                        IoTConnector.ApiUtils.CrudApiSDK.retrieveRecord(deviceId, IoTConnector.Common.Constants.Msdyn_iotdevice.EntityLogicalName, IoTConnector.Common.Constants.Msdyn_iotdevice.AttributeDeviceId, "")
                            .then(function (device) {
                            var connectedDeviceId = device[IoTConnector.Common.Constants.Msdyn_iotdevice.AttributeDeviceId];
                            IoTConnector.ApiUtils.Fields.SetValue(msdyn.IotAssetCommon.CustomerAssetForm.formContext, deviceIdFieldName_1, connectedDeviceId);
                            resolve();
                        }).catch(function (e) {
                            deviceIdField.setVisible(false);
                            IoTConnector.ApiUtils.ErrorMessageInConsole(e);
                            resolve();
                        });
                    }
                    else {
...
// Display send command button if there is one or more connected devices, otherwise hide it.
msdyn.IotAssetCommon.CustomerAssetForm.displayHideSendCommandButton = function (currentCountConnectedDevices) {
    if (msdyn.IotAssetCommon.CustomerAssetForm.isInitialFormLoad) {
        msdyn.IotAssetCommon.CustomerAssetForm.countConnectedDevices = currentCountConnectedDevices;
    }
    // Re-evaluate if some CFS buttons need to be displayed/hidden, namely send command.
    if (msdyn.IotAssetCommon.CustomerAssetForm.isRefreshRibbonNeeded(currentCountConnectedDevices)) {
        msdyn.IotAssetCommon.CustomerAssetForm.formContext.ui.refreshRibbon(false);
    }
    msdyn.IotAssetCommon.CustomerAssetForm.isInitialFormLoad = false;
};
// Checks if this is the initial loading of the page, and if not, determines if the number of connected devices
// will toggle the button, namely send command.
msdyn.IotAssetCommon.CustomerAssetForm.isRefreshRibbonNeeded = function (currentCountConnectedDevices) {
    var refreshNeeded = false;
    // msdyn.IotAssetCommon.CustomerAssetForm.isInitialFormLoad prevents double loading of the page.
    if (!msdyn.IotAssetCommon.CustomerAssetForm.isInitialFormLoad) {
        refreshNeeded = ((msdyn.IotAssetCommon.CustomerAssetForm.countConnectedDevices === 0 && currentCountConnectedDevices >= 1) ||
            (msdyn.IotAssetCommon.CustomerAssetForm.countConnectedDevices >= 1 && currentCountConnectedDevices === 0));
        // Update total connected devices count.
        msdyn.IotAssetCommon.CustomerAssetForm.countConnectedDevices = currentCountConnectedDevices;
    }
    return refreshNeeded;
};
msdyn.IotAssetCommon.CustomerAssetForm.showOrHideConnectedDeviceAttributesSection = function (generalTab) {
    return __awaiter(this, void 0, void 0, function () {
        var connectedDeviceAttributesSection, shouldShow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connectedDeviceAttributesSection = generalTab && generalTab.sections &&
                        generalTab.sections.get(IotAssetCommon.Common.Constants.SectionNames.ConnectedDeviceAttributesSection);
                    return [4 /*yield*/, msdyn.IotAssetCommon.CustomerAssetForm.getIsIotDeviceInUse()];
                case 1:
                    shouldShow = _a.sent();
                    if (!connectedDeviceAttributesSection)
                        return [2 /*return*/];
                    if (shouldShow) {
                        connectedDeviceAttributesSection.setVisible(shouldShow);
                    }
...
// Logic to get the connected devices of an asset.
// TODO: duplicate logic from CFS CustomerAssetForm.
msdyn.IotAssetCommon.CustomerAssetForm.getAssetConnectedDevicesIds = function (assetId) {
    return new Promise(function (resolve, reject) {
        IoTAssetCommon.Utils.IoTAssetCommonUtils.isEntityActive("msdyn_iotdevice").then(function (data) {
            if (data) {
                var record1Field = IoTConnector.ApiUtils.GetODataAttribute(IoTConnector.Common.Constants.Connection.EntityLogicalName, IoTConnector.Common.Constants.Connection.Record1IdValue);
                var record2Field = IoTConnector.ApiUtils.GetODataAttribute(IoTConnector.Common.Constants.Connection.EntityLogicalName, IoTConnector.Common.Constants.Connection.Record2IdValue);
                var record2RoleField = IoTConnector.ApiUtils.GetODataAttribute(IoTConnector.Common.Constants.Connection.EntityLogicalName, IoTConnector.Common.Constants.Connection.Record2RoleIdValue);
                IoTConnector.ApiUtils.CrudApiSDK.retrieveMultipleRecords(IoTConnector.Common.Constants.Connection.EntityLogicalName, "$select=" + record2Field + "&$filter=" + record1Field + " eq " + assetId + " and " + record2RoleField + " eq " + msdyn.IotAssetCommon.CustomerAssetForm.connectedDeviceRole, function (data) {
                    if (data && data.entities) {
                        var devicesIds = data.entities.map(function (e) { return e._record2id_value; });
                        resolve(devicesIds);
                    }
                    else {
                        resolve([]);
...
// Given an iotDeviceID, query to see if that associated device has a device id.
// Returns a promise with a boolean, true if the device has a device id, false otherwise.
// TODO: duplicate logic from CFS CustomerAssetForm.
msdyn.IotAssetCommon.CustomerAssetForm.doesConnectedDeviceHaveDeviceId = function (ioTDeviceId) {
    return new Promise(function (resolve, reject) {
        if (!ioTDeviceId) {
            resolve(false);
            return;
        }
        IoTConnector.ApiUtils.CrudApiSDK.retrieveRecord(ioTDeviceId, IoTConnector.Common.Constants.EntityLogicalNames.DeviceEntityLogicalName, IoTConnector.Common.Constants.Msdyn_iotdevice.AttributeDeviceId, null, function (data) { return resolve(data && data[IoTConnector.Common.Constants.Msdyn_iotdevice.AttributeDeviceId] !== null); }, function (err) {
            err && IoTConnector.ApiUtils.LogMessageInConsole(err.message);
            resolve(false);
        });
    });
