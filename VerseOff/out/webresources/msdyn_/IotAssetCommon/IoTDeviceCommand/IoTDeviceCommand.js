...
/// <reference path="../Constants/Constants.ts" />
var msdyn = msdyn || {};
msdyn.IoTDeviceCommand = msdyn.IoTDeviceCommand || {};
msdyn.IoTDeviceCommand.customViewGuidDevice = "ad319a99-978f-4e64-ab21-53b3f798c9a8";
msdyn.IoTDeviceCommand.customViewGuidAsset = "0380c27c-7ccb-47f8-8325-1741a4917e25";
msdyn.IoTDeviceCommand.customViewGuidAssetSecondary = "6be13935-1947-4111-bee2-c78ae0bc5248";
msdyn.IoTDeviceCommand.viewNameParam = "relatedIoTDevices";
msdyn.IoTDeviceCommand.onChangeCommandDialog = function (eventContext) {
    var formContext = eventContext ? eventContext.getFormContext() : null;
    if (!formContext) {
        return;
    }
    msdyn.IoTDeviceCommand.setupDeviceLookup(formContext, true);
};
msdyn.IoTDeviceCommand.onLoadMFD = function (eventContext) {
    var formContext = eventContext ? eventContext.getFormContext() : null;
    if (!formContext) {
        return;
    }
    var formAttributes = IoTConnector.Utils.CommandDialogUtils.getFormAttributes(formContext);
    var isMfdParamValue = IoTConnector.Utils.CommandDialogUtils.getFieldValue(IotAssetCommon.Common.Constants.CommandMFDParameters.CommandAttributeIsMFD, formAttributes);
    if (isMfdParamValue) {
        formContext.getControl("msdyn_device1").setVisible(false);
        var assetHideParamValue = IoTConnector.Utils.CommandDialogUtils.getFieldValue(IotAssetCommon.Common.Constants.CommandMFDParameters.CommandAttributeAssetHide, formAttributes);
        var assetViewNameParamValue = IoTConnector.Utils.CommandDialogUtils.getFieldValue(IotAssetCommon.Common.Constants.CommandMFDParameters.CommandAttributeAssetViewName, formAttributes);
        var assetViewFetchParamValue = IoTConnector.Utils.CommandDialogUtils.getFieldValue(IotAssetCommon.Common.Constants.CommandMFDParameters.CommandAttributeAssetViewFetch, formAttributes);
        var assetViewParamValue = IoTConnector.Utils.CommandDialogUtils.getFieldValue(IotAssetCommon.Common.Constants.CommandMFDParameters.CommandAttributeAssetView, formAttributes);
        var assetSecondaryViewNameParamValue = IoTConnector.Utils.CommandDialogUtils.getFieldValue(IotAssetCommon.Common.Constants.CommandMFDParameters.CommandAttributeAssetSecondaryViewName, formAttributes);
        var assetSecondaryViewFetchParamValue = IoTConnector.Utils.CommandDialogUtils.getFieldValue(IotAssetCommon.Common.Constants.CommandMFDParameters.CommandAttributeAssetSecondaryViewFetch, formAttributes);
        if (assetHideParamValue) {
            formContext.getControl("msdyn_device1").setVisible(true);
            formContext.getControl("msdyn_customerasset1").setVisible(false);
        }
        if (assetViewFetchParamValue && assetViewParamValue) {
            var viewName = assetViewNameParamValue ? assetViewNameParamValue : "Custom View"; // TODO change to localization
            formContext.getControl("msdyn_customerasset1").addCustomView(msdyn.IoTDeviceCommand.customViewGuidAsset, "msdyn_customerasset", viewName, assetViewFetchParamValue, assetViewParamValue, true);
        }
        if (assetSecondaryViewFetchParamValue && assetViewParamValue) {
            var viewName = assetSecondaryViewNameParamValue ? assetSecondaryViewNameParamValue : "Secondary Custom View"; // TODO change to localization
            formContext.getControl("msdyn_customerasset1").addCustomView(msdyn.IoTDeviceCommand.customViewGuidAssetSecondary, "msdyn_customerasset", viewName, assetSecondaryViewFetchParamValue, assetViewParamValue, false);
        }
        msdyn.IoTDeviceCommand.setupDeviceLookup(formContext, false);
    }
};
msdyn.IoTDeviceCommand.setupDeviceLookup = function (formContext, isSetToNull) {
    var assetAttribute = formContext.getAttribute("msdyn_customerasset");
    var asset = assetAttribute != null ? assetAttribute.getValue() : null;
    if (asset) {
        var assetId = asset[0].id;
        var fetchXml = msdyn.IoTDeviceCommand.getViewFetchXml(assetId);
        var viewXml = "<grid name=\"resultset\" jump=\"msdyn_name\" select=\"1\" icon=\"1\" preview=\"1\">\n                            <row name=\"result\" id=\"msdyn_iotdeviceid\">\n                            <cell name=\"msdyn_name\" width=\"300\" />\n                            <cell name=\"createdon\" width=\"125\" />\n                            </row>\n                        </grid>";
        IoTConnector.Utils.ODataUtils.executeRequest("GET", IoTConnector.Utils.ODataUtils.formatFetchXml("msdyn_iotdevices", fetchXml), "", function (data) {
            var devices = data.value;
            if (devices && devices.length > 1) {
                formContext.getControl("msdyn_device1").addCustomView(msdyn.IoTDeviceCommand.customViewGuidDevice, "msdyn_iotdevice", "Custom View", fetchXml, viewXml, true); // TODO localize
                formContext.getControl("msdyn_device").addCustomView(msdyn.IoTDeviceCommand.customViewGuidDevice, "msdyn_iotdevice", "Custom View", fetchXml, viewXml, true); // TODO localize
                if (isSetToNull) {
                    formContext.getAttribute("msdyn_device").setValue(null);
                    formContext.getAttribute("msdyn_device").fireOnChange();
                }
                formContext.getControl("msdyn_device1").setVisible(true);
                formContext.getControl("msdyn_device").setVisible(true);
            }
            else if (devices && devices.length == 1) {
                var relatedDevice = devices[0];
                var device = msdyn.RibbonUtils.CreateLookupEntity(IoTConnector.Common.Constants.EntityLogicalNames.DeviceEntityLogicalName, relatedDevice.msdyn_iotdeviceid, relatedDevice.msdyn_name);
                formContext.getControl("msdyn_device1").addCustomView(msdyn.IoTDeviceCommand.customViewGuidDevice, "msdyn_iotdevice", "Custom View", fetchXml, viewXml, true);
                formContext.getControl("msdyn_device").addCustomView(msdyn.IoTDeviceCommand.customViewGuidDevice, "msdyn_iotdevice", "Custom View", fetchXml, viewXml, true); // TODO localize
                formContext.getAttribute("msdyn_device").setValue([device]);
                formContext.getAttribute("msdyn_device").fireOnChange();
                formContext.getControl("msdyn_device1").setVisible(false);
                formContext.getControl("msdyn_device").setVisible(false);
            }
        }, function (err) {
            console.log(err.error.message);
        });
...
msdyn.IoTDeviceCommand.getViewFetchXml = function (assetId) {
    return "<fetch>\n                <entity name='msdyn_iotdevice'>\n                    <attribute name='msdyn_iotdeviceid'/>\n                    <attribute name='msdyn_name'/>\n                    <link-entity name='connection' from='record2id' to='msdyn_iotdeviceid' link-type='inner' alias='connection'>\n                        <filter type='and'>\n                            <condition attribute='record1id' operator='eq' value='" + assetId + "'/>\n                            <condition attribute='record2roleid' operator='eq' value='" + IotAssetCommon.Common.Constants.ConnectionConstants.ConnectedDeviceRole + "'/>\n                        </filter>\n                    </link-entity> \n                </entity>\n            </fetch>";
};
