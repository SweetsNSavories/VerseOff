    ...
    */
    var AccountLibrary = (function () {
        function AccountLibrary() {
            var _this = this;
            this.parentaccountid_setadditionalparams = function (context) {
                var entityId = Xrm.Page.data.entity.getId();
                if (!ClientUtility.DataUtil.isNullOrEmptyString(entityId)) {
                    var parentLookup = Xrm.Page.ui.controls.get("parentaccountid");
                    if (!ClientUtility.DataUtil.isNull(parentLookup)) {
                        var fetchXml = '<filter type="and"><condition attribute="accountid" operator="neq" value="';
                        fetchXml += Xrm.Encoding.xmlAttributeEncode(entityId);
                        fetchXml += '"/></filter>';
                        parentLookup.addCustomFilter(fetchXml);
                    }
                }
            };
            this.ra_onload = function () {
                ...
                //Hide Relationship Assistant if CDS org
            ...
            this.form_onload = function () {
                ...
                if ((formType != 3 /* ReadOnly */) && (formType != 2 /* Update */)) {
                    var ctrl = Xrm.Page.ui.controls.get("name");
                    if (!ClientUtility.DataUtil.isNullOrUndefined(ctrl) && !ctrl.getDisabled()) {
                        ctrl.setFocus();
                    }
                    ;
                }
            ...
            mscrm.parentaccountid_setadditionalparams = this.parentaccountid_setadditionalparams;
        }
        AccountLibrary.prototype.isUCI = function () {
            var global = window;
            var xrm = global.Xrm;
            var result = false;
    ...
    AppCommon.AccountLibrary = AccountLibrary;
})(AppCommon || (AppCommon = {}));
/**
* @license Copyright (c) Microsoft Corporation. All rights reserved.
*/
...
(function (AppCommon) {
    ...
    */
    ...
    Account.Instance = new AppCommon.AccountLibrary();
    Account.ctor = (function () {
    })();
    AppCommon.Account = Account;
})(AppCommon || (AppCommon = {}));
//# sourceMappingURL=Account_main_system_library.js.map