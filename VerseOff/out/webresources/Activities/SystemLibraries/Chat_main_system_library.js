...
(function (Activities) {
    var Constants;
    (function (Constants) {
        Constants.imageSrc = "WebResources/Activities/Images/OfficeChat.svg";
        Constants.CommonWebResource = "Activities/Resources/Activities";
        Constants.TeamsChatsPreviewLabel = "TeamsChatsPreview_Label";
        Constants.TeamsChatControlPaneId = "Microsoft.Dynamics.Activities.TeamsChatControl.Pane";
        Constants.GetCurrAppId = "Get current AppId";
        Constants.AppForOutlookModule = "AppforOutlookModule";
        Constants.ErrorAppProperties = "Unable to fetch app properties";
        Constants.EmbedCollabGetValue = "Embed collab setting - Retrieve value";
        Constants.ErrorCollabDisabled = "Embed collab setting is disabled";
        Constants.ErrorEmbedCollabGetValue = "Unable to fetch embed-collab setting value";
        Constants.EnableTeamsChatAppSetting = "msdyn_EnableTeamsChat";
        Constants.MsTeamsSettingsV2EntityLogicalName = "msdyn_msteamssettingsv2";
        Constants.EmbedcollabSettingAttributeLogicalName = "msdyn_embedcollabteamsintegrationenabled";
        Constants.EntityLinkChatConfiguration = "msdyn_entitylinkchatconfiguration";
    })(Constants = Activities.Constants || (Activities.Constants = {}));
})(Activities || (Activities = {}));
var Activities;
(function (Activities) {
    var TeamsChat = (function () {
        function TeamsChat() {
        }
        TeamsChat.getPane = function () {
            return __awaiter(this, void 0, void 0, function () {
                var title, pane;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            title = Activities.ClientApi.getResourceString(Activities.Constants.TeamsChatsPreviewLabel);
                            pane = Xrm.App.sidePanes.getPane(Activities.Constants.TeamsChatControlPaneId);
                            if (!!pane) return [3 /*break*/, 2];
                            return [4 /*yield*/, Xrm.App.sidePanes.createPane({
                                    alwaysRender: true,
                                    imageSrc: Activities.Constants.imageSrc,
                                    title: title,
                                    paneId: Activities.Constants.TeamsChatControlPaneId,
                                    hideHeader: true,
                                })];
                        case 1:
                            pane = _a.sent();
                            this.navigateToControl(pane);
                            _a.label = 2;
                        case 2: return [2 /*return*/, pane];
                    }
                });
            });
        };
        TeamsChat.openPane = function () {
            Activities.TeamsChat.getPane().then(function (pane) {
                pane.hidden = false;
                pane.select();
            });
            if (Xrm.App.sidePanes.getSelectedPane() &&
                Xrm.App.sidePanes.getSelectedPane().paneId === Activities.Constants.TeamsChatControlPaneId &&
                Xrm.App.sidePanes.state === 0) {
                Xrm.App.sidePanes.state = 1;
            }
        };
        TeamsChat.openPaneFromGrid = function () {
            Activities.TeamsChat.getPane().then(function (pane) {
                pane.hidden = true;
            });
        };
        TeamsChat.navigateToControl = function (pane) {
            pane.navigate({
                pageType: "control",
                controlName: "MscrmControls.TeamsChatControl",
                data: { TeamsChatControlPaneId: Activities.Constants.TeamsChatControlPaneId },
            });
        };
        TeamsChat.closePane = function () { };
        TeamsChat.expandPane = function () { };
        return TeamsChat;
    }());
    Activities.TeamsChat = TeamsChat;
})(Activities || (Activities = {}));
var Activities;
(function (Activities) {
    var TeamsChatTimelineConstants;
    (function (TeamsChatTimelineConstants) {
        TeamsChatTimelineConstants.ErrorChatParticipantValue = "Unable to fetch activity party for chat participant";
        TeamsChatTimelineConstants.ErrorEntityActiveConfigValue = "Unable to fetch active configuration entity value for joining chat";
        TeamsChatTimelineConstants.ErrorTeamsChatGetValue = "Unable to fetch Teams chat id value";
        TeamsChatTimelineConstants.ErrorJoiningTeamsChat = "Unable to join Teams chat";
        TeamsChatTimelineConstants.ErrorOpeningJoiningTeamsChat = "Unable to open or join Teams chat";
        TeamsChatTimelineConstants.ErrorOpeningTeamsChat = "Unable to open Teams chat";
        TeamsChatTimelineConstants.ErrorChatActivityIdValue = "Unable to fetch chat activity id";
        TeamsChatTimelineConstants.TeamsChatIdAttribute = "teamschatid";
        TeamsChatTimelineConstants.CollabSDKEventListenerType = "embedCollabSDKLoaded";
        TeamsChatTimelineConstants.FormattedEmptyGuid = "00000000-0000-0000-0000-000000000000";
        TeamsChatTimelineConstants.ChatEntity = "chat";
        TeamsChatTimelineConstants.ActivityPartyEntity = "activityparty";
        TeamsChatTimelineConstants.ChatParticipantTypeMask = "12";
        TeamsChatTimelineConstants.MultiSessionCollabControlPane = "AppSidePane_MscrmControls.OfficeProductivity.CollabControl";
    })(TeamsChatTimelineConstants = Activities.TeamsChatTimelineConstants || (Activities.TeamsChatTimelineConstants = {}));
})(Activities || (Activities = {}));
var Activities;
(function (Activities) {
    var TeamsChatCommands = (function () {
        function TeamsChatCommands() {
        }
        TeamsChatCommands.RecordSelectedTypeNotChat = function (records) {
            if (!records)
                return true;
            for (var _i = 0, records_1 = records; _i < records_1.length; _i++) {
                var record = records_1[_i];
                if (record.TypeName === Activities.Constants.EntityNames.Chat) {
                    return false;
                }
            }
            return true;
        };
        TeamsChatCommands.isOct2023FCBOn = function () {
            return Xrm.Internal.isFeatureEnabled("October2023Update");
        };
        TeamsChatCommands.isDefaultOnFCSOn = function () {
            var fcsValue = (Xrm.Utility.getGlobalContext()).getFeatureControlSetting("DynamicsTeamsIntegration.TeamsEmbedOP", "TeamsEmbedAppLevelConfig");
            if (fcsValue !== null || fcsValue !== undefined) {
                return fcsValue;
            }
            return false;
        };
        TeamsChatCommands.isEmbedAppSettingOn = function () {
            return Xrm.Utility.getGlobalContext().getCurrentAppSetting("msdyn_IsTeamsDynamicsIntegrationEnabled");
        };
        TeamsChatCommands.IsSaleSettingCollaborationEnabled = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 6, , 7]);
                            if (!(TeamsChatCommands.isOct2023FCBOn() && TeamsChatCommands.isDefaultOnFCSOn())) return [3 /*break*/, 2];
                            isSalesTeamsChatIntegrationEnabled = TeamsChatCommands.isEmbedAppSettingOn();
                            return [3 /*break*/, 5];
                        case 2:
                            if (!(this.IsSessionStorageEnabled() &&
                                sessionStorage.getItem(Activities.Constants.EmbedcollabSettingAttributeLogicalName) != null)) return [3 /*break*/, 3];
                            return [2 /*return*/, sessionStorage.getItem(Activities.Constants.EmbedcollabSettingAttributeLogicalName) === "true"];
                        case 3: return [4 /*yield*/, Xrm.WebApi.retrieveMultipleRecords(Activities.Constants.MsTeamsSettingsV2EntityLogicalName, "?$select=" + Activities.Constants.EmbedcollabSettingAttributeLogicalName)];
                        case 4:
                            ...
                            if (this.IsSessionStorageEnabled()) {
                                sessionStorage.setItem(Activities.Constants.EmbedcollabSettingAttributeLogicalName, isSalesTeamsChatIntegrationEnabled.toString());
                            }
                            _a.label = 5;
                        case 5: return [3 /*break*/, 7];
                        case 6:
                            err_1 = _a.sent();
                            Xrm.Reporting.reportFailure(Activities.Constants.EmbedCollabGetValue, Error(Activities.Constants.ErrorEmbedCollabGetValue + ("" + err_1.Message)));
                            return [3 /*break*/, 7];
        ...
        TeamsChatCommands.IsSessionStorageEnabled = function () {
            return sessionStorage !== null || sessionStorage !== undefined;
        };
        TeamsChatCommands.IsActivitySettingCollaborationEnabled = function () {
            return (Xrm.Utility.getGlobalContext().getCurrentAppSetting(Activities.Constants.EnableTeamsChatAppSetting) === true);
        };
        TeamsChatCommands.IsAcceptableAppContext = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, Xrm.Utility.getGlobalContext()
                            .getCurrentAppProperties()
                            .then(function (response) {
                            if (response.uniqueName === Activities.Constants.AppForOutlookModule) {
                                return false;
                            }
                            return Boolean(response.appId);
                        }, function (error) {
                            Xrm.Reporting.reportFailure(Activities.Constants.GetCurrAppId, Error(Activities.Constants.ErrorAppProperties + ("" + error.Message)));
                            return false;
                        })];
                });
            });
        };
        TeamsChatCommands.IsHostFromSameOrigin = function () {
            try {
        ...
        TeamsChatCommands.IsMobileClient = function () {
            return Xrm.Utility.getGlobalContext().client.getClient() === Xrm.Constants.ClientNames.mobile;
        };
        TeamsChatCommands.IsSovereignCloud = function () {
            return Xrm.Utility.getGlobalContext().organizationSettings.isSovereignCloud;
        };
        TeamsChatCommands.IsTeamsChatButtonVisible = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, isAcceptableAppContext, isSaleSettingCollaborationEnabled, err_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 3, , 4]);
                            if (!(this.IsActivitySettingCollaborationEnabled() &&
                                !this.IsMobileClient() &&
                                this.IsHostFromSameOrigin() &&
                                !this.IsSovereignCloud() &&
                                Xrm.Utility.getGlobalContext().client.getClient() !== Xrm.Constants.ClientNames.UnifiedServiceDesk &&
                                !Xrm.ExternalContext.getAvailableExternalContexts().get("MAIL_CONTEXT"))) return [3 /*break*/, 2];
                            return [4 /*yield*/, Promise.all([
                                    this.IsAcceptableAppContext(),
                                    this.IsSaleSettingCollaborationEnabled(),
                                ])];
                        case 1:
                            _a = _b.sent(), isAcceptableAppContext = _a[0], isSaleSettingCollaborationEnabled = _a[1];
                            return [2 /*return*/, isAcceptableAppContext && !isSaleSettingCollaborationEnabled];
        ...
        return TeamsChatCommands;
    }());
    Activities.TeamsChatCommands = TeamsChatCommands;
})(Activities || (Activities = {}));
var Activities;
(function (Activities) {
    var TeamsChatTimelineCommands = (function () {
        function TeamsChatTimelineCommands() {
        }
        TeamsChatTimelineCommands.isChatParticipant = function (chatActivityId, systemUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var filter;
                return __generator(this, function (_a) {
                    filter = "?$filter=participationtypemask eq " +
                        Activities.TeamsChatTimelineConstants.ChatParticipantTypeMask +
                        " and _activityid_value eq " +
                        chatActivityId +
                        " and _partyid_value eq " +
                        systemUserId +
                        " &$count=true&$select=participationtypemask,_activityid_value,_partyid_value";
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            Xrm.WebApi.retrieveMultipleRecords(Activities.TeamsChatTimelineConstants.ActivityPartyEntity, filter).then(function (result) {
                                resolve(result && result.entities && result.entities.length > 0);
                            }, function (error) {
                                Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorChatParticipantValue, Error(Activities.TeamsChatTimelineConstants.ErrorChatParticipantValue + ("" + error)));
                                reject(error);
                            });
                        })];
                });
        ...
        TeamsChatTimelineCommands.getTeamsChatId = function (chatActivityId) {
            return __awaiter(this, void 0, void 0, function () {
                var filter;
                return __generator(this, function (_a) {
                    filter = "?$select=" + Activities.TeamsChatTimelineConstants.TeamsChatIdAttribute;
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            Xrm.WebApi.retrieveRecord(Activities.TeamsChatTimelineConstants.ChatEntity, chatActivityId, filter).then(function (entity) {
                                resolve(entity[Activities.TeamsChatTimelineConstants.TeamsChatIdAttribute]);
                            }, function (error) {
                                Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorTeamsChatGetValue, Error(Activities.TeamsChatTimelineConstants.ErrorTeamsChatGetValue + ("" + error)));
                                reject(error);
                            });
                        })];
                });
        ...
        TeamsChatTimelineCommands.getActiveEntityLinkChatConfiguration = function (entityTypeRef) {
            return __awaiter(this, void 0, void 0, function () {
                var request;
                return __generator(this, function (_a) {
                    request = new Activities.EntityLinkChatConfigurationRequest(entityTypeRef);
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            Xrm.WebApi.online.execute(request).then(function (response) {
                                response.json().then(function (jsonEntity) {
                                    resolve(jsonEntity.msdyn_usercanjoinchat);
                                });
                            }, function (error) {
                                Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorEntityActiveConfigValue, Error(Activities.TeamsChatTimelineConstants.ErrorEntityActiveConfigValue + ("" + error)));
                                reject(error);
                            });
                        })];
                });
        ...
        TeamsChatTimelineCommands.joinTeamsChat = function (regardingEntity, teamsChatId, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var request;
                return __generator(this, function (_a) {
                    request = new Activities.JoinTeamsChatWithChatIdRequest(regardingEntity, teamsChatId, userId);
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            Xrm.WebApi.online.execute(request).then(function (response) {
                                resolve(true);
                            }, function (error) {
        ...
        TeamsChatTimelineCommands.isMultiSession = function () {
            if (window.top.Xrm && window.top.Xrm.App) {
                return window.top.Xrm.App.sessions;
            }
        };
        TeamsChatTimelineCommands.openChatById = function (teamsChatId, telemetryItem) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, isActivitySettingCollaborationEnabled, isSaleSettingCollaborationEnabled, embedClient, conversations, conversation, startTimeCollabPane, endTimeCollabPane, error_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, Promise.all([
                                Activities.TeamsChatCommands.IsActivitySettingCollaborationEnabled(),
                                Activities.TeamsChatCommands.IsSaleSettingCollaborationEnabled(),
                            ])];
                        case 1:
                            _a = _b.sent(), isActivitySettingCollaborationEnabled = _a[0], isSaleSettingCollaborationEnabled = _a[1];
                            if (!isActivitySettingCollaborationEnabled) return [3 /*break*/, 6];
                            if (!window.top._UCITeamsClient) return [3 /*break*/, 5];
                            return [4 /*yield*/, window.top._UCITeamsClient.getEmbedClient()];
                        case 2:
                            embedClient = _b.sent();
                            if (!(embedClient && embedClient.conversations)) return [3 /*break*/, 5];
                            return [4 /*yield*/, embedClient.conversations.get()];
                        case 3:
                            conversations = _b.sent();
                            if (!conversations) return [3 /*break*/, 5];
                        ...
                        case 6:
                            if (!isSaleSettingCollaborationEnabled) return [3 /*break*/, 14];
                            _b.label = 7;
                        case 7:
                            _b.trys.push([7, 11, 12, 13]);
                            if (!!window.top.collabSDKClient) return [3 /*break*/, 9];
                            startTimeCollabPane = performance.now();
                            return [4 /*yield*/, this.setSalesCollabSDKClient()];
                        case 8:
                            _b.sent();
                            endTimeCollabPane = performance.now();
                            telemetryItem.traceEventCustom("OpenCollabPaneTime", endTimeCollabPane - startTimeCollabPane);
                            _b.label = 9;
                        case 9: return [4 /*yield*/, window.top.collabSDKClient.openChatById(teamsChatId)];
                        case 10:
                            _b.sent();
                            return [3 /*break*/, 13];
                        case 11:
                            error_2 = _b.sent();
                            Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorOpeningTeamsChat, Error(Activities.TeamsChatTimelineConstants.ErrorOpeningTeamsChat + ("" + error_2.Message)));
                            return [3 /*break*/, 13];
                        case 12:
                        ...
                        case 14:
                            Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorOpeningTeamsChat, Error(Activities.Constants.ErrorCollabDisabled));
                            telemetryItem.traceEventError("Cannot open chat. Collab control is disabled");
                            telemetryItem.report();
                            _b.label = 15;
        ...
        TeamsChatTimelineCommands.setSalesCollabSDKClient = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!!window.top.collabSDK) return [3 /*break*/, 1];
                            window.top.addEventListener(Activities.TeamsChatTimelineConstants.CollabSDKEventListenerType, this.createSalesCollabSDKClient.bind(this));
                            return [3 /*break*/, 3];
        ...
        TeamsChatTimelineCommands.createSalesCollabSDKClient = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, window.top.collabSDK.createSDKClient({ hostCtx: "Timeline" }).then(function (clt) {
        ...
        TeamsChatTimelineCommands.removeCollabSDKEventListener = function () {
            window.top.removeEventListener(Activities.TeamsChatTimelineConstants.CollabSDKEventListenerType, this.createSalesCollabSDKClient);
        };
        TeamsChatTimelineCommands.joinChat = function (teamsChatId, primaryControl, entityRefType, telemetryItem) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                var entityRefId, regardingEntity, joinStartTime;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            entityRefId = primaryControl.data.entity.getId();
                            regardingEntity = {
                                id: entityRefId,
                                entityType: entityRefType,
                            };
                            joinStartTime = performance.now();
                            return [4 /*yield*/, this.joinTeamsChat(regardingEntity, teamsChatId, Activities.TeamsChatTimelineConstants.FormattedEmptyGuid)
                                    .then(function () {
                                    var joinEndTime = performance.now();
                                    telemetryItem.traceEventCustom("JoinChatRequestTime", joinEndTime - joinStartTime);
                                    _this.openChatById(teamsChatId, telemetryItem);
                                })
                                    .catch(function (error) {
                                    Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorJoiningTeamsChat, Error(Activities.TeamsChatTimelineConstants.ErrorJoiningTeamsChat + ("" + error)));
                                    Xrm.Navigation.openErrorDialog({ message: error.message, errorCode: error.errorCode });
                                    telemetryItem.traceEventError("Error while joining the chat from Timeline control.", error);
                                    telemetryItem.report();
                                })];
                        case 1:
                            _a.sent();
        ...
        TeamsChatTimelineCommands.getCurrentUserId = function () {
            var userContext = Xrm.Utility.getGlobalContext();
            return userContext.userSettings.userId;
        };
        TeamsChatTimelineCommands.openChatFromTimeline = function (selectedChatRecord, primaryControl) {
            return __awaiter(this, void 0, void 0, function () {
                var telemetryItem, startTime, isMultiSession, _a, alert_1, chatActivityId, systemUserId, _b, isChatParticipant, teamsChatId, endtime, entityRefType, canJoinChatConfiguration, endtime, alert_2, error_3, endtime;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            telemetryItem = new TelemetryLogger.TelemetryItem(Activities.Constants.EntityNames.Chat, Activities.Constants.TelemetryConstant.EventOpenChatFromTimeline);
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.isMSTeamsIntegrationSidePaneEnabled()];
                        case 2:
                            _a = !(_c.sent());
                            _c.label = 3;
                        case 3:
                            if (!_a) return [3 /*break*/, 4];
                            telemetryItem.traceEventWarning("Cannot open chat in multisession when Teams integration or productivity pane is disabled");
                            alert_1 = {
                                text: Activities.ClientApi.getResourceString("TeamsChatsDisabledDialogAlert"),
                            };
                            Xrm.Navigation.openAlertDialog(alert_1);
                            return [3 /*break*/, 13];
                        case 4:
                            if (!(selectedChatRecord.length === 1 && selectedChatRecord[0].Id)) return [3 /*break*/, 12];
                            chatActivityId = selectedChatRecord[0].Id;
                            systemUserId = this.getCurrentUserId();
                            return [4 /*yield*/, Promise.all([
                                    this.isChatParticipant(chatActivityId, systemUserId),
                                    this.getTeamsChatId(chatActivityId),
                                ])];
                        case 5:
                            _b = _c.sent(), isChatParticipant = _b[0], teamsChatId = _b[1];
                            if (!isChatParticipant) return [3 /*break*/, 7];
                            return [4 /*yield*/, this.openChatById(teamsChatId, telemetryItem)];
                        case 6:
                            _c.sent();
                            endtime = performance.now();
                            telemetryItem.traceEventCustom("OpenChatTime", endtime - startTime);
                            telemetryItem.traceEventInformation("Opened chat from " + (isMultiSession ? "multisession" : "single session") + " app");
                            return [3 /*break*/, 11];
                        case 7:
                            entityRefType = primaryControl.data.entity._entityType;
                            return [4 /*yield*/, TeamsChatTimelineCommands.getActiveEntityLinkChatConfiguration(entityRefType)];
                        case 8:
                            canJoinChatConfiguration = _c.sent();
                            if (!canJoinChatConfiguration) return [3 /*break*/, 10];
                            return [4 /*yield*/, this.joinChat(teamsChatId, primaryControl, entityRefType, telemetryItem)];
                        case 9:
                            _c.sent();
                            endtime = performance.now();
                            telemetryItem.traceEventCustom("JoinAndOpenChatTime", endtime - startTime);
                            telemetryItem.traceEventInformation("Joined and opened chat from " + (isMultiSession ? "multisession" : "single session") + " app");
                            return [3 /*break*/, 11];
                        case 10:
                            alert_2 = {
                                text: Activities.ClientApi.getResourceString("TeamsChatsJoinNotAllowedDialogAlert"),
                            };
                            Xrm.Navigation.openAlertDialog(alert_2);
                            telemetryItem.traceEventWarning("Cannot join chat. " + entityRefType + " entity is not enabled to join chat");
                            _c.label = 11;
                        case 11:
                            telemetryItem.report();
                            return [3 /*break*/, 13];
                        case 12:
                            Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorOpeningJoiningTeamsChat, Error(Activities.TeamsChatTimelineConstants.ErrorChatActivityIdValue));
                            _c.label = 13;
                        case 13: return [3 /*break*/, 15];
                        case 14:
                            error_3 = _c.sent();
                            Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorOpeningJoiningTeamsChat, Error(Activities.TeamsChatTimelineConstants.ErrorOpeningJoiningTeamsChat + ("" + error_3.Message)));
                            endtime = performance.now();
                            telemetryItem.traceEventError(Activities.TeamsChatTimelineConstants.ErrorOpeningJoiningTeamsChat + " time taken " + (endtime - startTime) + " ms", error_3.message);
                            telemetryItem.report();
                            return [3 /*break*/, 15];
                        case 15: return [2 /*return*/];
                    }
        ...
        TeamsChatTimelineCommands.isMSTeamsIntegrationSidePaneEnabled = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, isActivitySettingCollaborationEnabled, isSaleSettingCollaborationEnabled;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, Promise.all([
                                Activities.TeamsChatCommands.IsActivitySettingCollaborationEnabled(),
                        ...
                        case 1:
                            _a = _b.sent(), isActivitySettingCollaborationEnabled = _a[0], isSaleSettingCollaborationEnabled = _a[1];
                            if (!isActivitySettingCollaborationEnabled && isSaleSettingCollaborationEnabled) {
                                if (Xrm.App && Xrm.App.sidePanes) {
                                    return [2 /*return*/, Xrm.App.sidePanes.getPane(Activities.TeamsChatTimelineConstants.MultiSessionCollabControlPane) ? true : false];
                                }
                                else {
                                    Xrm.Reporting.reportFailure(Activities.TeamsChatTimelineConstants.ErrorOpeningJoiningTeamsChat, Error(Activities.TeamsChatTimelineConstants.ErrorOpeningJoiningTeamsChat));
                                    return [2 /*return*/, false];
                                }
                            }
                            else {
        ...
        return TeamsChatTimelineCommands;
    }());
    Activities.TeamsChatTimelineCommands = TeamsChatTimelineCommands;
})(Activities || (Activities = {}));
var Activities;
(function (Activities) {
    var EntityLinkChatConfigurationRequest = (function () {
        function EntityLinkChatConfigurationRequest(RegardingEntityName) {
            this.RegardingEntityName = RegardingEntityName;
        }
        EntityLinkChatConfigurationRequest.prototype.getMetadata = function () {
            var metadata = {
                operationName: "GetEntityLinkChatConfig",
                operationType: 0,
                parameterTypes: {
                    RegardingEntityName: {
                        typeName: "Edm.String",
        ...
        return EntityLinkChatConfigurationRequest;
    }());
    Activities.EntityLinkChatConfigurationRequest = EntityLinkChatConfigurationRequest;
})(Activities || (Activities = {}));
var Activities;
(function (Activities) {
    var JoinTeamsChatWithChatIdRequest = (function () {
        function JoinTeamsChatWithChatIdRequest(RegardingEntity, TeamsChatId, UserId) {
            this.RegardingEntity = RegardingEntity;
            this.TeamsChatId = TeamsChatId;
            this.UserId = UserId;
        }
        JoinTeamsChatWithChatIdRequest.prototype.getMetadata = function () {
            var metadata = {
                operationName: "JoinLinkedChat",
                operationType: 0,
                parameterTypes: {
                    RegardingEntity: {
        ...
        return JoinTeamsChatWithChatIdRequest;
    }());
    Activities.JoinTeamsChatWithChatIdRequest = JoinTeamsChatWithChatIdRequest;
})(Activities || (Activities = {}));
//# sourceMappingURL=TeamsChat.js.map